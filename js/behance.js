...
----------------------------------------------------------------------------------------------- */
var behance_username = "chrisvenning"; // behance user name - CHANGE THIS TO YOUR USER NAME
var selector = "behance_feed";
...
function format_results(e) {
    ...
    for (var i = 0; i < e.responseData.feed.entries.length; i++) {
        ...
        content = "<a href='" + entry.link + "' target='_blank'>" + content;
